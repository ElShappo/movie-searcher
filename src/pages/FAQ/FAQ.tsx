    ...
    <main className="text-lg px-64 py-8">
      <div className="flex flex-col gap-5">
        ...
        <p className="bg-slate-800 p-4 rounded-xl">
          ...
          <p className="pt-2">
            Возможные ошибки со стороны API обрабатываются - мне неудачном запросе пользователь увидит на сайте
        ...
        <p className="bg-slate-800 p-4 rounded-xl">
          ...
          (авторизация состоит из ввода имени пользователя и пароля).
          <div className="pt-2">
            <p>
